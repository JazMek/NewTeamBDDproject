...
//    public void user_complete_login_with_id_password(String string, String string) {
//        mCT_HomePageSD.user_complete_login_with_id_password_Step(string,string);
//    }
//
//    @Then("User see  profile name as {string}")
//    public void user_see_profile_name_as(String string) {
//        mCT_HomePageSD.user_see_profile_name_as("JAZ MEK");
//    }
